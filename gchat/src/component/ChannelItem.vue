    ...
    <div>
        ...
        <div class="channel-avatar">
            <div class="avatar-wrapper">
                ...
                <div v-else-if="channelType === 'group' && !avatar" class="avatar-multiple-wrapper" style="transform: rotate(-45deg);">
                    <div class="ant-avatar-group">
                            <span class="ant-avatar ant-avatar-circle ant-avatar-image avatar-channel" style="width: 38px; height: 38px; line-height: 38px; font-size: 15.2px; transform: rotate(45deg); z-index: 2; background-color: rgb(6, 146, 85);">
                                <img :src="`${groupImages[0].avatar}`" alt="avatar-channel"/>
                            </span>
                            <span class="ant-avatar ant-avatar-circle ant-avatar-image avatar-channel" style="width: 38px; height: 38px; line-height: 38px; font-size: 15.2px; transform: rotate(45deg); z-index: 1; background-color: rgb(6, 146, 85);">
            ...
            <div class="channel-message">
                <div class="channel-message-left">
                    <div class="channel-message-text">
                        <span v-if="channelType === 'group'">{{ lastMessage.sender.fullname.split(' ').pop() }}:&nbsp;</span>
                ...
                <div class="channel-message-more">
                    <div class="channel-notify" v-if="countMessageUnread > 0">
                        <span class="ant-badge ant-badge-not-a-wrapper">
                            <sup data-show="true" class="ant-scroll-number ant-badge-count ant-badge-multiple-words">
